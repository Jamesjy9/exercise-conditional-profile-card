...
function render(variables = {}) {
  ...
  if (variables.twitter == null) variables.twitter = "jamesnore...";
  if (variables.instagram == null) variables.instagram = "jamesnore...";
  if (variables.linkedin == null) variables.linkedin = "jamesnore...";
  if (variables.github == null) variables.github = "jamesjy9...";
